                ...
                <div class="modal-body">
                    <form name="addTags">
                        <div class="form-group" :class="{true:'has-error',false:''}[!newTag.name]">
                            ...
                            <input type="text" class="form-control" name="tagname" v-model="newTag.name" placeholder="请输入标签名称" required>
                        </div>
                        <div class="form-group" :class="{true:'has-error',false:''}[!newTag.catalogue_name]">
                            <label class="control-label">分类名/Cat.</label>
                            <input type="text" class="form-control" name="catname" v-model="newTag.catalogue_name" placeholder="请输入分类名称" required>
                        </div>
                    </form>
                </div>
